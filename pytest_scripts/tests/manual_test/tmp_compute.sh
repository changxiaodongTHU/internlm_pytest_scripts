...
if [[ ${RAY_VERSION} != 'ray, version 1.13.0' ]]; then
    echo 'Ray version must be 1.13.0!'
    exit 1
fi
...
RAYLOG=/mnt/cache/share_data/$USER/ray
        ...
        srun --nodes=1 --ntasks=1 -w "$node_i" \
            ...
            $nsys_cmd profile -o $nsys_profile_name --wait=all \
                ...
                ray start --address "$ip_head" \
                    ...
                    --resources='{"COMPUTE": 100000000000000.0, "'${target_label}'": 100000000000000.0}' \
                    --temp-dir=$RAYLOG \
